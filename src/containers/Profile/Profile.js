...
export class Profile extends Component {
  ...
  render() {
    const { first_name, last_name, identities, location, interests, cohort, program, current_job, slack, email, phone, linkedin, preferred_method, background, tech_skills, non_tech_skills, availability } = this.props.user;
    ...
    const userInterests = <UserInterests profile={true} interests={interests} />
    ...
    return (
      <div className="link-content">
        ...
        <ProfileSection name="Interests" content={userInterests} />
